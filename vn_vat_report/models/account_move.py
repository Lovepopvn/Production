	...
	def _recompute_tax_lines(self, recompute_tax_base_amount=False):
		...
		for taxes_map_entry in taxes_map.values():
			...
			if not tax_line and not taxes_map_entry['grouping_dict']:
				...
				if 'grouping_dict' in taxes_map_entry:
					if 'vat_in_config_id' in taxes_map_entry['grouping_dict']:
						vat_in_config = taxes_map_entry['grouping_dict']['vat_in_config_id']
				tax_line.update({
					...
					'vat_in_config_id':vat_in_config,
				})
			else:
