...
from odoo.addons.vn_accounting.models.account_financial_html_report import AccountFinancialHtmlReport
...
class AccountReportCustom(models.AbstractModel):
	...
	# 	b01 = self.env.ref('vn_accounting.account_financial_report_b01')
	...
	# 	b01 = self.env.ref('vn_accounting.account_financial_report_b01')
	# 	pnl01 = self.env.ref('vn_accounting.account_financial_report_pnl_b02')
